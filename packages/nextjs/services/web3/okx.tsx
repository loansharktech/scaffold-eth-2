...
import { ConnectorNotFoundError, ResourceUnavailableError, RpcError, UserRejectedRequestError } from "wagmi";
...
export const okxWallet = ({ chains }: OKXWalletOptions): Wallet => {
  const isInjected = typeof window !== "undefined" && typeof window.okxwallet !== "undefined";
  ...
  return {
    ...
    downloadUrls: {
      browserExtension: "https://chrome.google.com/webstore/detail/okx-wallet/mcohilncbfahbmgdjkbpemcciiolgcge?hl=en",
      ...
      return {
        ...
        qrCode: shouldUseWalletConnect
          ? {
              getUri,
              instructions: {
                learnMoreUrl: "https://www.okx.com/support/hc/en-us/sections/360003035872",
                steps: [
                  {
