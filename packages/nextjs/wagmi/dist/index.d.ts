...
declare function createClient<TProvider extends Provider, TWebSocketProvider extends WebSocketProvider>({
  queryClient,
  storage,
  persister,
  ...config
}: CreateClientConfig<TProvider, TWebSocketProvider>): Client$1<TProvider, TWebSocketProvider> & {
  queryClient: QueryClient;
};
type Client<
  TProvider extends Provider = Provider,
  TWebSocketProvider extends WebSocketProvider = WebSocketProvider,
> = Client$1<TProvider, TWebSocketProvider> & {
  queryClient: QueryClient;
};
...
declare function WagmiConfig<TProvider extends Provider, TWebSocketProvider extends WebSocketProvider>({
  children,
  client,
}: React.PropsWithChildren<WagmiConfigProps<TProvider, TWebSocketProvider>>): React.FunctionComponentElement<
  React.ProviderProps<Client<Provider, WebSocketProvider> | undefined>
>;
declare function useClient<
...
declare function useMutation<TData = unknown, TError = unknown, TVariables = void, TContext = unknown>(
...
declare module "ethers/lib/utils.js" {
  ...
  function verifyTypedData<TTypedData extends TypedData, TSchema extends TypedDataToPrimitiveTypes<TTypedData>>(
...
type InfiniteQueryConfig<TData, TError, TSelectData = TData> = Pick<
...
declare function useBalance({
  ...
  onSettled,
  onSuccess,
}?: UseBalanceArgs & UseBalanceConfig): UseQueryResult<FetchBalanceResult, Error>;
...
type UseSignerConfig = Omit<QueryConfig<FetchSignerResult, Error>, "cacheTime" | "staleTime" | "enabled"> &
  FetchSignerArgs;
declare function useSigner<TSigner extends Signer>({
  chainId: chainId_,
  suspense,
  onError,
  onSettled,
  onSuccess,
}?: UseSignerConfig): UseQueryResult<FetchSignerResult<TSigner>, Error>;
...
type UseSignTypedDataConfig<
  TTypedData extends
    | TypedData
    | {
        [key: string]: unknown;
      } = TypedData,
> = MutationConfig<SignTypedDataResult, Error, SignTypedDataArgs<TTypedData>> & UseSignTypedDataArgs<TTypedData>;
declare function useSignTypedData<TTypedData extends TypedData>({
  domain,
  types,
  value,
  onError,
  ...
  onSettled,
  onSuccess,
}?: UseSignTypedDataConfig<TTypedData>): {
  ...
  isSuccess: boolean;
  reset: () => void;
  signTypedData: <TTypedDataMutate extends TypedData = TTypedData>(
    args?: UseSignTypedDataArgs<TTypedDataMutate> | undefined,
  ) => void;
  signTypedDataAsync: <TTypedDataMutate_1 extends TypedData = TTypedData>(
    args?: UseSignTypedDataArgs<TTypedDataMutate_1> | undefined,
  ) => Promise<string>;
  status: "error" | "success" | "loading" | "idle";
  variables:
    | SignTypedDataArgs<
        ...
        TTypedData extends TypedData
          ? abitype.TypedDataToPrimitiveTypes<TTypedData>
          : {
              [key: string]: any;
            },
        (TTypedData extends TypedData
          ...
          : {
              [key: string]: any;
            })[keyof (TTypedData extends TypedData
          ? abitype.TypedDataToPrimitiveTypes<TTypedData>
          : {
              [key: string]: any;
            })]
...
type UseContractConfig<TAbi extends Abi | readonly unknown[] = Abi> = Partial<
  Pick<GetContractArgs<TAbi>, "abi" | "address">
> & {
  /** Signer or provider to attach to contract */
  signerOrProvider?: GetContractArgs["signerOrProvider"] | null;
};
declare function useContract<TAbi extends Abi | readonly unknown[]>({
  address,
  abi,
  signerOrProvider,
}?: UseContractConfig<TAbi>): GetContractResult<TAbi> | null;
...
>;
declare function useContractEvent<TAbi extends Abi | readonly unknown[], TEventName extends string>({
  address,
  chainId,
  abi,
  listener,
  eventName,
  once,
}?: UseContractEventConfig<TAbi, TEventName>): void;
type GetListener<
  TAbi extends Abi | readonly unknown[],
  TEventName extends string,
  TAbiEvent extends AbiEvent = TAbi extends Abi ? ExtractAbiEvent<TAbi, TEventName> : AbiEvent,
...
declare function useContractInfiniteReads<
  TAbi extends Abi | readonly unknown[],
...
>({
  ...
  structuralSharing,
  suspense,
}: UseContractInfiniteReadsConfig<TContracts, TPageParam, TSelectData>): UseInfiniteQueryResult<TSelectData, Error>;
declare function paginatedIndexesConfig<
  TAbi extends Abi | readonly unknown[],
  TFunctionName extends string,
  TContracts extends {
    abi: TAbi;
...
> = PartialBy<ReadContractConfig<TAbi, TFunctionName>, "abi" | "address" | "args" | "functionName"> &
...
declare function useContractRead<
  TAbi extends Abi | readonly unknown[],
  TFunctionName extends string,
  TSelectData = ReadContractResult<TAbi, TFunctionName>,
>({
  ...
  suspense,
  watch,
}?: UseContractReadConfig<TAbi, TFunctionName, TSelectData>): UseQueryResult<TSelectData, Error>;
...
declare function useContractReads<
  TAbi extends Abi | readonly unknown[],
  TFunctionName extends string,
  TContracts extends {
    abi: TAbi;
...
>({
  ...
  suspense,
  watch,
}?: UseContractReadsConfig<TContracts, TSelectData>): UseQueryResult<TSelectData, Error>;

type UseContractWriteArgs<
...
> = {
  ...
  | PartialBy<WriteContractPreparedArgs<TAbi, TFunctionName>, "abi" | "address" | "functionName" | "request">
  | PartialBy<WriteContractUnpreparedArgs<TAbi, TFunctionName>, "abi" | "address" | "args" | "functionName">
);
type UseContractWriteConfig<
  TMode extends WriteContractMode = WriteContractMode,
  TAbi extends Abi | readonly unknown[] = Abi,
  TFunctionName extends string = string,
> = MutationConfig<WriteContractResult, Error, UseContractWriteArgs<TMode, TAbi, TFunctionName>> &
 ...
 *
 */
declare function useContractWrite<
...
>(
  ...
  write:
    | MutationFn<TMode & "prepared", TAbi, TFunctionName, void>
    | MutationFn<TMode & WriteContractUnpreparedArgs<TAbi, TFunctionName>["mode"], TAbi, TFunctionName, void>;
  writeAsync:
    | MutationFn<TMode & "prepared", TAbi, TFunctionName, Promise<_wagmi_core.SendTransactionResult>>
    | MutationFn<
        TMode & WriteContractUnpreparedArgs<TAbi, TFunctionName>["mode"],
        TAbi,
        TFunctionName,
        Promise<_wagmi_core.SendTransactionResult>
      >;
};
...
>({
  ...
  onSettled,
  onSuccess,
}?: UsePrepareContractWriteConfig<TAbi, TFunctionName, TChainId>): Pick<
  _tanstack_react_query.QueryObserverResult<PrepareWriteContractResult<TAbi, TFunctionName, TChainId>, Error>,
  | "data"
  | "error"
  | "isError"
  | "isLoading"
...
> & {
  ...
  status: "error" | "success" | "loading" | "idle";
  internal: Pick<
    _tanstack_react_query.QueryObserverResult<unknown, unknown>,
    | "isLoadingError"
    | "isRefetchError"
    | "dataUpdatedAt"
    | "errorUpdatedAt"
...
declare function useEnsResolver({
  ...
  onSettled,
  onSuccess,
}?: UseEnsResolverArgs & UseEnsResolverConfig): UseQueryResult<_ethersproject_providers.Resolver | null, Error>;
...
declare function useBlockNumber({
  cacheTime,
  chainId: chainId_,
  enabled,
  scopeKey,
  ...
  onSettled,
  onSuccess,
}?: UseBlockNumberArgs & UseBlockNumberConfig): UseQueryResult<number, Error>;
...
declare function useFeeData({
  ...
  onSettled,
  onSuccess,
}?: UseFeeDataArgs & UseFeedDataConfig): UseQueryResult<FetchFeeDataResult, Error>;
...
declare function useWebSocketProvider<TWebSocketProvider extends WebSocketProvider>({
  chainId,
}?: UseWebSocketProviderArgs): _wagmi_core.GetWebSocketProviderResult<TWebSocketProvider>;

type UsePrepareSendTransactionConfig = Partial<PrepareSendTransactionArgs> &
 ...
 */
declare function usePrepareSendTransaction({
  chainId,
  request,
  cacheTime,
  enabled,
  ...
  onSettled,
  onSuccess,
}?: UsePrepareSendTransactionConfig): Pick<
  _tanstack_react_query.QueryObserverResult<PrepareSendTransactionResult, Error>,
  | "data"
  | "error"
  | "isError"
  | "isLoading"
 ...
 * const result = useSendTransaction(config)
 */
declare function useSendTransaction<Args extends UseSendTransactionArgs = UseSendTransactionArgs>({
  chainId,
  mode,
  request,
  onError,
...
declare function useTransaction({
  ...
  onSettled,
  onSuccess,
}?: UseTransactionArgs & UseTransactionConfig): UseQueryResult<_ethersproject_providers.TransactionResponse, Error>;
...
declare function useWaitForTransaction({
  chainId: chainId_,
  confirmations,
  hash,
  timeout,
  ...
  onSettled,
  onSuccess,
}?: UseWaitForTransactionArgs & UseWaitForTransactionConfig): UseQueryResult<
  _ethersproject_providers.TransactionReceipt,
  Error
>;
...
declare function useWatchPendingTransactions({
  chainId: chainId_,
  enabled,
  listener,
}: UseWatchPendingTransactionsConfig): void;
